const CACHE='gestao-gastos-v41';
const ASSETS=['./','./index.html','./pierre-layout.css?v=40','./ui-modern-v2.js?v=34','./ui-home-v39.js?v=39','./ui-home-guard-v41.js?v=41','./logo-meu-financeiro.svg?v=36','./app-icon.svg?v=35','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
