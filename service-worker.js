const CACHE='gestao-gastos-v35';
const ASSETS=['./','./index.html','./pierre-layout.css?v=33','./ui-modern-v2.js?v=34','./logo-meu-financeiro.svg?v=33','./app-icon.svg?v=35','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
