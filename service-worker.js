const CACHE='gestao-gastos-v37';
const ASSETS=['./','./index.html','./pierre-layout.css?v=33','./ui-modern-v2.js?v=34','./ui-fix-v36.js?v=36','./ui-home-v37.js?v=37','./logo-meu-financeiro.svg?v=36','./app-icon.svg?v=35','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
