const CACHE='gestao-gastos-v51';
const ASSETS=['./','./index.html','./pierre-layout.css?v=40','./app-v50.js?v=50','./app-user-fix-v51.js?v=51','./logo-meu-financeiro.svg?v=36','./app-icon.svg?v=35','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
...
function adicionarLayout(response){return response.text().then(html=>{
  ...
  html=html.replace(/<script[^>]*src=["'][^"']*(?:ui-modern-v2|ui-fix-v36|ui-home-v37|ui-home-fix-v38|ui-home-v39|ui-home-guard-v41|ui-modal-fix-v42|app-v50|app-user-fix-v51)\.js[^"']*["'][^>]*><\/script>\s*/gi,'');
